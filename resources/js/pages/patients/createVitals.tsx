...
export default function CreateVitals() {
    ...
    const validateField = (name, value) => {
        ...
        if (
            ...
            (numValue < threshold.min || numValue > threshold.max)
        ) {
            return {
                isValid: false,
        ...
        if (
            threshold.normalMin !== undefined &&
            threshold.normalMax !== undefined
        ) {
            if (numValue < threshold.normalMin) {
                return {
                    isValid: true,
                    error: '',
                    warning: `Low (Normal: ${threshold.normalMin}-${threshold.normalMax})`,
                };
            }
            if (numValue > threshold.normalMax) {
                return {
                    isValid: true,
                    error: '',
                    warning: `High (Normal: ${threshold.normalMin}-${threshold.normalMax})`,
                };
            }
        }
            ...
            if (name === 'height' || name === 'weight') {
                ...
                if (height && weight && height > 0) {
                    ...
                    if (bmiNum < thresholds.bmi.normalMin) {
                        setAbnormalWarnings((prev) => ({
                            ...prev,
                            bmi: `Underweight: BMI ${bmiNum}`,
                        }));
                    } else if (bmiNum > thresholds.bmi.normalMax) {
                        setAbnormalWarnings((prev) => ({
                            ...prev,
                            bmi: `Overweight: BMI ${bmiNum}`,
                        }));
                    } else {
    ...
    const submitToApi = async () => {
        try {
            ...
            if (response.data.status === 201) {
                ...
                setTimeout(
                    () => router.visit(`/patients/vital-signs/${patientId}`),
                    1000,
                );
            }
        } catch (error) {
                        ...
                        <Alert className="border-yellow-500 bg-yellow-50">
                            ...
                            <AlertDescription>
                                <ul className="mt-2 list-inside list-disc space-y-1 text-yellow-700">
                                    {Object.values(abnormalWarnings)
                                        .filter((w) => w)
                                        .map((warning, index) => (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            <TabsList className="grid h-auto grid-cols-2 gap-2 bg-transparent p-0 md:grid-cols-7">
                                <TabsTrigger
                                    value="bp"
                                    className="rounded-lg border border-blue-200 py-2 font-semibold text-gray-500 hover:bg-blue-100 data-[state=active]:bg-black data-[state=active]:text-white"
                                >
                                    <Activity className="mr-2 h-4 w-4" /> BP
                                </TabsTrigger>
                                <TabsTrigger
                                    value="pulse"
                                    className="rounded-lg border border-blue-200 py-2 font-semibold text-gray-500 hover:bg-blue-100 data-[state=active]:bg-black data-[state=active]:text-white"
                                >
                                    <Heart className="mr-2 h-4 w-4" /> Pulse &
                                    O2
                                </TabsTrigger>
                                <TabsTrigger
                                    value="temp"
                                ...
                                <TabsTrigger
                                    ...
                                    className="rounded-lg border border-blue-200 py-2 font-semibold text-gray-500 hover:bg-blue-100 data-[state=active]:bg-black data-[state=active]:text-white"
                                >
                                    <Droplet className="mr-2 h-4 w-4" /> Glucose
                                </TabsTrigger>
                                <TabsTrigger
                                    value="body"
                                    className="rounded-lg border border-blue-200 py-2 font-semibold text-gray-500 hover:bg-blue-100 data-[state=active]:bg-black data-[state=active]:text-white"
                                >
                                    <Ruler className="mr-2 h-4 w-4" /> Body
                                </TabsTrigger>
                                <TabsTrigger
                                    value="circumference"
                                    className="rounded-lg border border-blue-200 py-2 font-semibold text-gray-500 hover:bg-blue-100 data-[state=active]:bg-black data-[state=active]:text-white"
                                ...
                                <TabsTrigger
                                    ...
                                    className="rounded-lg border border-blue-200 py-2 font-semibold text-gray-500 hover:bg-blue-100 data-[state=active]:bg-black data-[state=active]:text-white"
                                >
                                    <Info className="mr-2 h-4 w-4" /> Additional
                                </TabsTrigger>
                            </TabsList>
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            ...
                                            <div>
                                                <Label className="flex items-center justify-between">
                                                    <span>BMI</span>
                                                    <span className="rounded-full bg-blue-100 px-2 py-1 text-xs text-gray-500">
                                                        Normal: 18.5-24.9
                                                    </span>
                                                </Label>
                                                <Input
                                ...
                                <Card>
                                    <CardContent className="space-y-6 pt-6">
                                        ...
                                        {formData.systolic_bp &&
                                            formData.diastolic_bp && (
                                                <div
                                                    className={`rounded-lg p-4 ${getBPClassification(formData.systolic_bp, formData.diastolic_bp)?.bg || 'bg-gray-50'}`}
                                                >
                                                    <p
                                                        className={`text-sm font-medium ${getBPClassification(formData.systolic_bp, formData.diastolic_bp)?.color || 'text-gray-600'}`}
                                                    >
                                                        Classification:{' '}
                                                        {getBPClassification(
                                                            formData.systolic_bp,
                                    ...
                                    <CardContent className="pt-6">
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                {abnormalWarnings.respiratory_rate &&
                                                    !validationErrors.respiratory_rate && (
                                                        <p className="mt-1 text-xs text-yellow-500">
                                                            {
                                                                abnormalWarnings.respiratory_rate
                                ...
                                <Card>
                                    <CardContent className="pt-6">
                                        <div className="max-w-md">
                                            ...
                                            />
                                            {validationErrors.blood_glucose && (
                                                <p className="mt-1 text-xs text-red-500">
                                                    {
                                                        validationErrors.blood_glucose
                                                    }
                                            ...
                                            {abnormalWarnings.blood_glucose &&
                                                !validationErrors.blood_glucose && (
                                                    <p className="mt-1 text-xs text-yellow-500">
                                                        {
                                                            abnormalWarnings.blood_glucose
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    placeholder="85"
                                                    value={
                                                        formData.abdominal_circumference
                                                    }
                                                    onChange={handleInputChange}
                                                />
                                            </div>
                                    ...
                                    <CardContent className="pt-6">
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                rows="5"
                                                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                                                placeholder="Additional observations, patient condition, medications..."
